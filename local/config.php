...
$PageLogoUrl = "$PubDirUrl/skins/prom2/logo_prom.png";
...
if ($action == 'rss' || $action == 'rdf' || $action == 'atom' || $action == 'dc') { include_once('scripts/feeds.php'); }
...
## Include german language file. 
XLPage('de','PmWikiDe.XLPage');
XLPage('de','PmWikiDe.XLPageCookbook');

## Define Defaults. 
$DefaultGroup = 'Prometheus'; # Standardgruppe, Voreinstellung: 'Main'
$DefaultName = 'Inhalt'; # Startseite jeder Gruppe, Voreinstellung: 'HomePage'
$DefaultPage = 'Prometheus.Prometheus';

## MailPosts <http://prometheus-web.uni-koeln.de/wiki/pmwiki.php/PmWiki/MailPosts>
...
#$MailPostsItemFmt=" * \$FullName . . . \$PostTime by \$Author\n     \$PageUrl");  # include the page's URL in the message

## Load additional configuration files
foreach (glob(dirname(__FILE__)."/conf.d/*.php") as $filename) {
